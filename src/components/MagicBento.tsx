...
const defaultCardData: BentoCardData[] = [
  ...
  },
  {
    color: '#120F17',
    title: 'AI & Automation',
    description: 'Intelligent pipelines & multi-agent decision systems',
    label: '03 / Intelligence',
    techs: ['n8n', 'OpenAI', 'Claude', 'LangChain', 'Python']
  },
  {
    color: '#120F17',
    title: 'Backend & APIs',
    description: 'High-throughput microservices & distributed endpoints',
  ...
  },
  {
    ...
    description: 'Relational, NoSQL and in-memory caches',
    label: '05 / Storage',
    techs: ['PostgreSQL', 'MongoDB', 'Prisma', 'Redis', 'Firebase']
  },
  {
    color: '#120F17',
    title: 'Cloud & DevOps',
          ...
          const cardInnerContent = (
            <>
              ...
              <div className="magic-bento-card__content my-auto py-1">
                ...
                {card.description && (
                  <p className="magic-bento-card__description mb-3.5">{card.description}</p>
                )}
                ...
                {card.techs && card.techs.length > 0 && (
                  <div className="flex flex-wrap items-center gap-2 pt-2 mt-auto">
                    {card.techs.map((tech) => (
                      <div
                        key={tech}
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-[#1E1A29] hover:bg-[#2A243A] border border-[#362E48] hover:border-[#8400FF]/80 rounded-xl transition-all duration-200 group/pill cursor-default shadow-sm"
                        title={tech}
                      >
