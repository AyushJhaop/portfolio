    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl w-full">
        ...
        <div className="w-full flex justify-center mb-16 sm:mb-20 md:mb-24">
          <AnimatedText
            text="I'm Ayush Jha, a Full-Stack Developer and AI Automation Engineer passionate about building modern web applications and intelligent automation.

I create scalable, user-focused digital products that solve real-world problems.
"
